...
import {
  ...
  requireAuth,
  validateRequest,
} from '@vetal-tickets/common';
import { body } from 'express-validator';
import { Ticket } from '../models/ticket';
import { Order } from '../models/order';
import { OrderCreatedPblisher } from '../events/publishers/order-created-publisher';
...
router.post(
  ...
  async (req: Request, res: Response) => {
    ...
    new OrderCreatedPblisher(natsWrapper.client).publish({
      id: order.id,
